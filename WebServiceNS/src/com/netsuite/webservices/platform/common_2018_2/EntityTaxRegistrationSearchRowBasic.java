...
public class EntityTaxRegistrationSearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] address;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnLongField[] id;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] nexusCountry;
    ...
    public EntityTaxRegistrationSearchRowBasic(
           com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] address,
           com.netsuite.webservices.platform.core_2018_2.SearchColumnLongField[] id,
           com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] nexusCountry,
     ...
     * @return address
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] getAddress() {
        return address;
    }
     ...
     * @param address
     */
    public void setAddress(com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] address) {
        this.address = address;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField getAddress(int i) {
        return this.address[i];
    }

    public void setAddress(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField _value) {
     ...
     * @return nexusCountry
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] getNexusCountry() {
        return nexusCountry;
    }
     ...
     * @param nexusCountry
     */
    public void setNexusCountry(com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] nexusCountry) {
        this.nexusCountry = nexusCountry;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField getNexusCountry(int i) {
        return this.nexusCountry[i];
    }

    public void setNexusCountry(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "EntityTaxRegistrationSearchRowBasic"));
