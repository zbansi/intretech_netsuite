...
public class GetSavedSearchResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.RecordRef[] recordRefList;
    ...
    public GetSavedSearchResult(
           ...
           com.netsuite.webservices.platform.core_2017_1.RecordRef[] recordRefList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2017_1.RecordRef[] getRecordRefList() {
        return recordRefList;
    }
     ...
     * @param recordRefList
     */
    public void setRecordRefList(com.netsuite.webservices.platform.core_2017_1.RecordRef[] recordRefList) {
        this.recordRefList = recordRefList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "GetSavedSearchResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "recordRefList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "RecordRefList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
