...
public class TransactionColumnCustomFieldFilter  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef[] fldFilterSelList;
    ...
    public TransactionColumnCustomFieldFilter(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef[] fldFilterSelList,
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef[] getFldFilterSelList() {
        return fldFilterSelList;
    }
     ...
     */
    public void setFldFilterSelList(com.netsuite.webservices.platform.core_2019_1.RecordRef[] fldFilterSelList) {
        this.fldFilterSelList = fldFilterSelList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "TransactionColumnCustomFieldFilter"));
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "fldFilterSel"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
