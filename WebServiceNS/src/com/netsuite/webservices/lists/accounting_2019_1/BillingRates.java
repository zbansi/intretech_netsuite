...
public class BillingRates  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2019_1.Rate[] rateList;
    ...
    public BillingRates(
           ...
           com.netsuite.webservices.lists.accounting_2019_1.Rate[] rateList) {
     ...
     * @return rateList
     */
    public com.netsuite.webservices.lists.accounting_2019_1.Rate[] getRateList() {
        return rateList;
    }
     ...
     * @param rateList
     */
    public void setRateList(com.netsuite.webservices.lists.accounting_2019_1.Rate[] rateList) {
        this.rateList = rateList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "rate"));
        typeDesc.addFieldDesc(elemField);
    }
