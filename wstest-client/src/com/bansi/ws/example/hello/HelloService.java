 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://example.ws.bansi.com/", wsdlLocation = "http://localhost:8080/wstest/service/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://example.ws.bansi.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/wstest/service/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://example.ws.bansi.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.ws.bansi.com/", "HelloPort"), Hello.class, features);
    }
