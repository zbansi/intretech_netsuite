...
package com.bansi.ws.example.sayhi;
 ...
 * 
 */
@WebServiceClient(name = "SayHiServiceImpService", targetNamespace = "http://example.ws.bansi.com/", wsdlLocation = "http://localhost:7775/wstest/service/sayhi?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHISERVICEIMPSERVICE_QNAME = new QName("http://example.ws.bansi.com/", "SayHiServiceImpService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7775/wstest/service/sayhi?wsdl");
    ...
    public SayHiService getSayHiServiceImpPort() {
        return super.getPort(new QName("http://example.ws.bansi.com/", "SayHiServiceImpPort"), SayHiService.class);
    }
    ...
    public SayHiService getSayHiServiceImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.ws.bansi.com/", "SayHiServiceImpPort"), SayHiService.class, features);
    }
