...
function(record, search, runtime, dao, utils) {
	 ...
	 * 
	 * requestParams.filterList: 娣峰悎浜岀淮鏁版嵁锛屽伓鏁板厓绱犳槸闀垮害2鎴����戒竴缁存暟鎹紙璋撹瘝瑕佺礌锛夛紝濂囨暟鍏冪礌鏄拷1锟��借緫杩愮畻绗����	 * requestParams.filterList = [ [ 'name', 'is', 'EAI.TEST.190422A01-cBOM' ] ];
	 * 
	 */
