...
import com.netsuite.webservices.platform.core_2018_2.AttachBasicReference;
import com.netsuite.webservices.platform.core_2018_2.AttachContactReference;
...
import com.netsuite.webservices.platform.core_2018_2.BudgetExchangeRate;
...
import com.netsuite.webservices.platform.core_2018_2.CurrencyRate;
...
import com.netsuite.webservices.platform.core_2018_2.DeletedRecord;
import com.netsuite.webservices.platform.core_2018_2.DeletionReason;
import com.netsuite.webservices.platform.core_2018_2.DetachBasicReference;
...
import com.netsuite.webservices.platform.core_2018_2.InitializeRef;
import com.netsuite.webservices.platform.core_2018_2.ItemAvailability;
...
import com.netsuite.webservices.platform.messages_2018_2.ApplicationInfo;
import com.netsuite.webservices.platform.messages_2018_2.AsyncResult;
import com.netsuite.webservices.platform.messages_2018_2.Preferences;
...
import com.netsuite.webservices.platform.messages_2018_2.SearchPreferences;
...
public class WsClient_2018_2 extends WsCoreClient_2018_2 implements WebServicesSoapClient {
	private static final Logger LOG = Logger.getLogger(WsClient_2018_2.class);
	 ...
	 */
	public WsClient_2018_2(URL url) {
		super(url);
	 ...
	 * @param url      URL to which the requests are sent
	 */
	public WsClient_2018_2(Passport passport, URL url) {
		this(url);
	 ...
	 * @param url         URL to which the requests are sent
	 */
	public WsClient_2018_2(SsoPassport ssoPassport, URL url) {
		this(url);
	 ...
	 * @param url           URL to which the requests are sent
	 */
	public WsClient_2018_2(TokenPassport tokenPassport, URL url) {
		this(url);
	 ...
	 * @param url           URL to which the requests are sent
	 */
	public WsClient_2018_2(OAuthPassport oAuthPassport, URL url) {
		this(url);
	...
	public SessionResponse callLogin(Passport passport) throws RemoteException {
		com.netsuite.webservices.platform.core_2018_2.Passport endpointSpecificPassport = com.bansi.webservices.samples.v2018_2.Utils.convertPassport(passport);
	...
	/*public SessionResponse callSsoLogin(SsoPassport ssoPassport) throws RemoteException {
		com.netsuite.webservices.platform.core_2018_2.SsoPassport endpointSsoPassport = com.bansi.webservices.samples.v2019_1.Utils.convertSsoPassport(ssoPassport);
		SessionResponse sessionResponse;
		synchronized (this) {
