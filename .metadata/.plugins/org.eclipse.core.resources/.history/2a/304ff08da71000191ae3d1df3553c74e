...
package com.netsuite.webservices.general.communication_2017_1.types;
...
public class MessageMessageType implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.communication_2017_1.general.webservices.netsuite.com", "MessageMessageType"));
    }
    /**
