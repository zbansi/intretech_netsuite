...
package com.netsuite.webservices.documents.filecabinet_2017_1.types;
...
public class FolderFolderType implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.filecabinet_2017_1.documents.webservices.netsuite.com", "FolderFolderType"));
    }
    /**
