...
public class PricingGroupSearchRow  extends com.netsuite.webservices.platform.core_2017_1.SearchRow  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2017_1.PricingGroupSearchRowBasic basic;
    ...
    public PricingGroupSearchRow(
           com.netsuite.webservices.platform.common_2017_1.PricingGroupSearchRowBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2017_1.PricingGroupSearchRowBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2017_1.PricingGroupSearchRowBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "PricingGroupSearchRow"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "PricingGroupSearchRowBasic"));
