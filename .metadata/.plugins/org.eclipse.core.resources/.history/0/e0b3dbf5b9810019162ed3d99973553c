...
public class CampaignResponse  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.marketing_2019_1.CampaignResponseResponses[] responsesList;
    ...
    public CampaignResponse(
           ...
           com.netsuite.webservices.lists.marketing_2019_1.CampaignResponseResponses[] responsesList) {
        super(
            nullFieldList);
     ...
     */
    public com.netsuite.webservices.lists.marketing_2019_1.CampaignResponseResponses[] getResponsesList() {
        return responsesList;
    }
     ...
     * @param responsesList
     */
    public void setResponsesList(com.netsuite.webservices.lists.marketing_2019_1.CampaignResponseResponses[] responsesList) {
        this.responsesList = responsesList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:marketing_2019_1.lists.webservices.netsuite.com", "responses"));
        typeDesc.addFieldDesc(elemField);
    }
