...
public class GetBudgetExchangeRateResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.BudgetExchangeRate[] budgetExchangeRateList;
    ...
    public GetBudgetExchangeRateResult(
           ...
           com.netsuite.webservices.platform.core_2018_2.BudgetExchangeRate[] budgetExchangeRateList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2018_2.BudgetExchangeRate[] getBudgetExchangeRateList() {
        return budgetExchangeRateList;
    }
     ...
     */
    public void setBudgetExchangeRateList(com.netsuite.webservices.platform.core_2018_2.BudgetExchangeRate[] budgetExchangeRateList) {
        this.budgetExchangeRateList = budgetExchangeRateList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "GetBudgetExchangeRateResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "budgetExchangeRateList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "BudgetExchangeRate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "budgetExchangeRate"));
        typeDesc.addFieldDesc(elemField);
    }
