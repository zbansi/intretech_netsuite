...
public class BinWorksheet  extends com.netsuite.webservices.platform.core_2018_2.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.transactions.inventory_2018_2.BinWorksheetItem[] itemList;
    ...
    public BinWorksheet(
           ...
           com.netsuite.webservices.transactions.inventory_2018_2.BinWorksheetItem[] itemList,
     ...
     * @return itemList
     */
    public com.netsuite.webservices.transactions.inventory_2018_2.BinWorksheetItem[] getItemList() {
        return itemList;
    }
     ...
     * @param itemList
     */
    public void setItemList(com.netsuite.webservices.transactions.inventory_2018_2.BinWorksheetItem[] itemList) {
        this.itemList = itemList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2018_2.transactions.webservices.netsuite.com", "BinWorksheet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:inventory_2018_2.transactions.webservices.netsuite.com", "BinWorksheetItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
