...
public class AddressSearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnBooleanField[] override;
    ...
    public AddressSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchColumnBooleanField[] override,
     ...
     * @return override
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnBooleanField[] getOverride() {
        return override;
    }
     ...
     * @param override
     */
    public void setOverride(com.netsuite.webservices.platform.core_2018_2.SearchColumnBooleanField[] override) {
        this.override = override;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnBooleanField getOverride(int i) {
        return this.override[i];
    }

    public void setOverride(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnBooleanField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "AddressSearchRowBasic"));
