...
public class GetPostingTransactionSummaryResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.PostingTransactionSummary[] postingTransactionSummaryList;
    ...
    public GetPostingTransactionSummaryResult(
           ...
           com.netsuite.webservices.platform.core_2019_1.PostingTransactionSummary[] postingTransactionSummaryList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.PostingTransactionSummary[] getPostingTransactionSummaryList() {
        return postingTransactionSummaryList;
    }
     ...
     */
    public void setPostingTransactionSummaryList(com.netsuite.webservices.platform.core_2019_1.PostingTransactionSummary[] postingTransactionSummaryList) {
        this.postingTransactionSummaryList = postingTransactionSummaryList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "postingTransactionSummary"));
        typeDesc.addFieldDesc(elemField);
    }
