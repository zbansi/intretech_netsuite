...
public class SubsidiaryAccountingBookDetail  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2017_1.types.AccountingBookStatus bookStatus;
    ...
    public SubsidiaryAccountingBookDetail(
           ...
           com.netsuite.webservices.lists.accounting_2017_1.types.AccountingBookStatus bookStatus) {
     ...
     * @return bookStatus
     */
    public com.netsuite.webservices.lists.accounting_2017_1.types.AccountingBookStatus getBookStatus() {
        return bookStatus;
    }
     ...
     * @param bookStatus
     */
    public void setBookStatus(com.netsuite.webservices.lists.accounting_2017_1.types.AccountingBookStatus bookStatus) {
        this.bookStatus = bookStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "SubsidiaryAccountingBookDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "bookStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2017_1.lists.webservices.netsuite.com", "AccountingBookStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
