...
public class ItemRevisionSearchBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    public ItemRevisionSearchBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchDateField obsoleteDate) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "ItemRevisionSearchBasic"));
