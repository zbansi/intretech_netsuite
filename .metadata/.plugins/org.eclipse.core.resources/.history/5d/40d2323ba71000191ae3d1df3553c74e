...
public class SearchTextNumberField  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.types.SearchTextNumberFieldOperator operator;  // attribute
    ...
    public SearchTextNumberField(
           ...
           com.netsuite.webservices.platform.core_2017_1.types.SearchTextNumberFieldOperator operator) {
     ...
     * @return operator
     */
    public com.netsuite.webservices.platform.core_2017_1.types.SearchTextNumberFieldOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(com.netsuite.webservices.platform.core_2017_1.types.SearchTextNumberFieldOperator operator) {
        this.operator = operator;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchTextNumberField"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("operator");
        attrField.setXmlName(new javax.xml.namespace.QName("", "operator"));
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2017_1.platform.webservices.netsuite.com", "SearchTextNumberFieldOperator"));
