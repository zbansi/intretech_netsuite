...
public class CustomSegment  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef[] filteredByList;
    ...
    public CustomSegment(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef[] filteredByList,
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef[] getFilteredByList() {
        return filteredByList;
    }
     ...
     */
    public void setFilteredByList(com.netsuite.webservices.platform.core_2019_1.RecordRef[] filteredByList) {
        this.filteredByList = filteredByList;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.filteredByList==null && other.getFilteredByList()==null) || 
             (this.filteredByList!=null &&
              java.util.Arrays.equals(this.filteredByList, other.getFilteredByList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getFilteredByList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getFilteredByList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getFilteredByList(), i);
                if (obj != null &&
