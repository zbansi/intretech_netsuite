...
public class DemandPlan  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.transactions.demandplanning_2019_1.PeriodDemandPlan[] periodDemandPlanList;
    ...
    public DemandPlan(
           ...
           com.netsuite.webservices.transactions.demandplanning_2019_1.PeriodDemandPlan[] periodDemandPlanList) {
     ...
     */
    public com.netsuite.webservices.transactions.demandplanning_2019_1.PeriodDemandPlan[] getPeriodDemandPlanList() {
        return periodDemandPlanList;
    }
     ...
     */
    public void setPeriodDemandPlanList(com.netsuite.webservices.transactions.demandplanning_2019_1.PeriodDemandPlan[] periodDemandPlanList) {
        this.periodDemandPlanList = periodDemandPlanList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:demandplanning_2019_1.transactions.webservices.netsuite.com", "periodDemandPlan"));
        typeDesc.addFieldDesc(elemField);
    }
