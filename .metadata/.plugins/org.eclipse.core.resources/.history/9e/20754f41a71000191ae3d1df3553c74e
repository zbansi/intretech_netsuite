...
public class ItemSearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] hierarchyNode;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] hierarchyVersion;
     ...
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] getHierarchyNode() {
        return hierarchyNode;
    }
     ...
     * @param hierarchyNode
     */
    public void setHierarchyNode(com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] hierarchyNode) {
        this.hierarchyNode = hierarchyNode;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField getHierarchyNode(int i) {
        return this.hierarchyNode[i];
    }

    public void setHierarchyNode(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField _value) {
     ...
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] getHierarchyVersion() {
        return hierarchyVersion;
    }
     ...
     */
    public void setHierarchyVersion(com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] hierarchyVersion) {
        this.hierarchyVersion = hierarchyVersion;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField getHierarchyVersion(int i) {
        return this.hierarchyVersion[i];
    }

    public void setHierarchyVersion(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField _value) {
