...
public class SerializedAssemblyItemBillOfMaterials  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef[] defaultForLocationList;
    ...
    public SerializedAssemblyItemBillOfMaterials(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef[] defaultForLocationList,
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef[] getDefaultForLocationList() {
        return defaultForLocationList;
    }
     ...
     */
    public void setDefaultForLocationList(com.netsuite.webservices.platform.core_2019_1.RecordRef[] defaultForLocationList) {
        this.defaultForLocationList = defaultForLocationList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "SerializedAssemblyItemBillOfMaterials"));
