...
public class PromotionCodeCurrency  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "PromotionCodeCurrency"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("currency");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "currency"));
