...
public class SolutionSearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] displayOnline;
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] previewref;

    private com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] solutionCode;
    ...
    public SolutionSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] displayOnline,
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] previewref,
           com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] solutionCode,
     ...
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] getDisplayOnline() {
        return displayOnline;
    }
     ...
     * @param displayOnline
     */
    public void setDisplayOnline(com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] displayOnline) {
        this.displayOnline = displayOnline;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField getDisplayOnline(int i) {
        return this.displayOnline[i];
    }

    public void setDisplayOnline(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField _value) {
     ...
     * @return previewref
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] getPreviewref() {
        return previewref;
    }
     ...
     * @param previewref
     */
    public void setPreviewref(com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] previewref) {
        this.previewref = previewref;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField getPreviewref(int i) {
        return this.previewref[i];
    }

    public void setPreviewref(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField _value) {
     ...
     * @return solutionCode
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] getSolutionCode() {
        return solutionCode;
    }
     ...
     * @param solutionCode
     */
    public void setSolutionCode(com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] solutionCode) {
        this.solutionCode = solutionCode;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField getSolutionCode(int i) {
        return this.solutionCode[i];
    }

    public void setSolutionCode(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "SolutionSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "displayOnline"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "previewref"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchColumnStringField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "solutionCode"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchColumnStringField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
