...
public class CurrencyRateSearchBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRecordBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2017_1.RecordRef[] baseCurrency;
    ...
    private com.netsuite.webservices.platform.core_2017_1.RecordRef[] transactionCurrency;

    public CurrencyRateSearchBasic() {
    }

    public CurrencyRateSearchBasic(
           com.netsuite.webservices.platform.core_2017_1.RecordRef[] baseCurrency,
           ...
           com.netsuite.webservices.platform.core_2017_1.RecordRef[] transactionCurrency) {
     ...
     * @return baseCurrency
     */
    public com.netsuite.webservices.platform.core_2017_1.RecordRef[] getBaseCurrency() {
        return baseCurrency;
    }
     ...
     * @param baseCurrency
     */
    public void setBaseCurrency(com.netsuite.webservices.platform.core_2017_1.RecordRef[] baseCurrency) {
        this.baseCurrency = baseCurrency;
    }
     ...
     */
    public com.netsuite.webservices.platform.core_2017_1.RecordRef[] getTransactionCurrency() {
        return transactionCurrency;
    }
     ...
     */
    public void setTransactionCurrency(com.netsuite.webservices.platform.core_2017_1.RecordRef[] transactionCurrency) {
        this.transactionCurrency = transactionCurrency;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "CurrencyRateSearchBasic"));
