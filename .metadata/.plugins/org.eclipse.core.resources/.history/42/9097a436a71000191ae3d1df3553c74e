...
public class GetSelectValueResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.BaseRef[] baseRefList;
    ...
    public GetSelectValueResult(
           ...
           com.netsuite.webservices.platform.core_2017_1.BaseRef[] baseRefList) {
           this.status = status;
     ...
     * @return baseRefList
     */
    public com.netsuite.webservices.platform.core_2017_1.BaseRef[] getBaseRefList() {
        return baseRefList;
    }
     ...
     * @param baseRefList
     */
    public void setBaseRefList(com.netsuite.webservices.platform.core_2017_1.BaseRef[] baseRefList) {
        this.baseRefList = baseRefList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "GetSelectValueResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "baseRefList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "BaseRefList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
