...
public class TimeSheetSearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] totalHours;
    ...
    public TimeSheetSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] totalHours,
     ...
     * @return totalHours
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] getTotalHours() {
        return totalHours;
    }
     ...
     * @param totalHours
     */
    public void setTotalHours(com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] totalHours) {
        this.totalHours = totalHours;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField getTotalHours(int i) {
        return this.totalHours[i];
    }

    public void setTotalHours(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "TimeSheetSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "totalHours"));
