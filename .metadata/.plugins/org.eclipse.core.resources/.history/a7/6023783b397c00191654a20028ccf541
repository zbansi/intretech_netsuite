...
public class GetCustomizationIdResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.CustomizationRef[] customizationRefList;
    ...
    public GetCustomizationIdResult(
           ...
           com.netsuite.webservices.platform.core_2019_1.CustomizationRef[] customizationRefList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.CustomizationRef[] getCustomizationRefList() {
        return customizationRefList;
    }
     ...
     */
    public void setCustomizationRefList(com.netsuite.webservices.platform.core_2019_1.CustomizationRef[] customizationRefList) {
        this.customizationRefList = customizationRefList;
    }
