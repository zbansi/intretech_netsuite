...
public class DescriptionItem  extends com.netsuite.webservices.platform.core_2018_2.Record  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2018_2.lists.webservices.netsuite.com", "DescriptionItem"));
