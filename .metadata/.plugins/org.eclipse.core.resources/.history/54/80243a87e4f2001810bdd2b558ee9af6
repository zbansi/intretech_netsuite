...
public class VendorCategorySearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] isTaxAgency;
    ...
    public VendorCategorySearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] isTaxAgency,
     ...
     * @return isTaxAgency
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] getIsTaxAgency() {
        return isTaxAgency;
    }
     ...
     * @param isTaxAgency
     */
    public void setIsTaxAgency(com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] isTaxAgency) {
        this.isTaxAgency = isTaxAgency;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField getIsTaxAgency(int i) {
        return this.isTaxAgency[i];
    }

    public void setIsTaxAgency(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "VendorCategorySearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "isTaxAgency"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchColumnBooleanField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
