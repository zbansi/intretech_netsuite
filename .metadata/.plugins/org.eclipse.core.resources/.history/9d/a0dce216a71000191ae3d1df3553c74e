...
public class InventoryTransfer  extends com.netsuite.webservices.platform.core_2017_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.transactions.inventory_2017_1.InventoryTransferInventory[] inventoryList;
    ...
    public InventoryTransfer(
           ...
           com.netsuite.webservices.transactions.inventory_2017_1.InventoryTransferInventory[] inventoryList) {
        super(
            nullFieldList);
     ...
     */
    public com.netsuite.webservices.transactions.inventory_2017_1.InventoryTransferInventory[] getInventoryList() {
        return inventoryList;
    }
     ...
     * @param inventoryList
     */
    public void setInventoryList(com.netsuite.webservices.transactions.inventory_2017_1.InventoryTransferInventory[] inventoryList) {
        this.inventoryList = inventoryList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "InventoryTransfer"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "InventoryTransferInventory"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
