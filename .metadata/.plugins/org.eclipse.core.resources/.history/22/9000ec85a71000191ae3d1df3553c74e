...
public class NonInventorySaleItem  extends com.netsuite.webservices.platform.core_2017_1.Record  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "NonInventorySaleItem"));
