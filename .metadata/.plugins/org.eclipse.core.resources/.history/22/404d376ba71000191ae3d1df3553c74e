...
public class CouponCodeSearchAdvanced  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearch criteria;

    private com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearchRow columns;
    ...
    public CouponCodeSearchAdvanced(
           ...
           com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearch criteria,
           com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearchRow columns) {
     ...
     * @return criteria
     */
    public com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearch getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearch criteria) {
        this.criteria = criteria;
    }
     ...
     * @return columns
     */
    public com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearchRow getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.netsuite.webservices.lists.marketing_2017_1.CouponCodeSearchRow columns) {
        this.columns = columns;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "CouponCodeSearchAdvanced"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "CouponCodeSearch"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "CouponCodeSearchRow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
