...
public class CustomRecordCustomField  extends com.netsuite.webservices.setup.customization_2019_1.CustomFieldType  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.setup.customization_2019_1.CustomRecordCustomFieldFilter[] filterList;
    ...
    public CustomRecordCustomField(
           ...
           com.netsuite.webservices.setup.customization_2019_1.CustomRecordCustomFieldFilter[] filterList,
     ...
     * @return filterList
     */
    public com.netsuite.webservices.setup.customization_2019_1.CustomRecordCustomFieldFilter[] getFilterList() {
        return filterList;
    }
     ...
     * @param filterList
     */
    public void setFilterList(com.netsuite.webservices.setup.customization_2019_1.CustomRecordCustomFieldFilter[] filterList) {
        this.filterList = filterList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "CustomRecordCustomFieldFilter"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
