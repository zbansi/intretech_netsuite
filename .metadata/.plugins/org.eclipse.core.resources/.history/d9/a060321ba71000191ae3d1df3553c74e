...
package com.netsuite.webservices.transactions.employees_2017_1.types;
...
public class TimeBillTimeType implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.employees_2017_1.transactions.webservices.netsuite.com", "TimeBillTimeType"));
    }
    /**
