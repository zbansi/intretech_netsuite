...
package com.netsuite.webservices.lists.relationships_2017_1.types;
...
public class CustomerNegativeNumberFormat implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.relationships_2017_1.lists.webservices.netsuite.com", "CustomerNegativeNumberFormat"));
    }
    /**
