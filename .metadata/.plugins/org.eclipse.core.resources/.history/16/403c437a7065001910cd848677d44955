...
public class ExpenseCategory  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2019_1.ExpenseCategoryRates[] ratesList;
    ...
    public ExpenseCategory(
           ...
           com.netsuite.webservices.lists.accounting_2019_1.ExpenseCategoryRates[] ratesList,
     ...
     * @return ratesList
     */
    public com.netsuite.webservices.lists.accounting_2019_1.ExpenseCategoryRates[] getRatesList() {
        return ratesList;
    }
     ...
     * @param ratesList
     */
    public void setRatesList(com.netsuite.webservices.lists.accounting_2019_1.ExpenseCategoryRates[] ratesList) {
        this.ratesList = ratesList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "expenseCategoryRates"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
