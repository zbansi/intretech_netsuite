...
package com.netsuite.webservices.lists.accounting_2017_1.types;
...
public class BillingScheduleRecurrenceRecurrenceUnits implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2017_1.lists.webservices.netsuite.com", "BillingScheduleRecurrenceRecurrenceUnits"));
    }
    /**
