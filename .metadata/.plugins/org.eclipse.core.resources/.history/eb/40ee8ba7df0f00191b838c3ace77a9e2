...
public class ManufacturingCostTemplateSearchRow  extends com.netsuite.webservices.platform.core_2018_2.SearchRow  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2018_2.ManufacturingCostTemplateSearchRowBasic basic;
    ...
    public ManufacturingCostTemplateSearchRow(
           com.netsuite.webservices.platform.common_2018_2.ManufacturingCostTemplateSearchRowBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2018_2.ManufacturingCostTemplateSearchRowBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2018_2.ManufacturingCostTemplateSearchRowBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:supplychain_2018_2.lists.webservices.netsuite.com", "ManufacturingCostTemplateSearchRow"));
