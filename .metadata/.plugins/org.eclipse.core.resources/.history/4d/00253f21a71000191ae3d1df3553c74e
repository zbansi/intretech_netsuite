...
public class CustomerPaymentDeposit  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customers_2017_1.transactions.webservices.netsuite.com", "CustomerPaymentDeposit"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customers_2017_1.transactions.webservices.netsuite.com", "depositDate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customers_2017_1.transactions.webservices.netsuite.com", "remaining"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
