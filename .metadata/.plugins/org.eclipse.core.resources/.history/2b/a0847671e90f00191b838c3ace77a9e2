...
public class AsyncAddListResult  extends com.netsuite.webservices.platform.messages_2018_2.AsyncResult  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2018_2.platform.webservices.netsuite.com", "AsyncAddListResult"));
