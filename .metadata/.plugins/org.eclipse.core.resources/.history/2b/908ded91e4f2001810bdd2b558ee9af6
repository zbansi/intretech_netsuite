...
package com.netsuite.webservices.lists.employees_2017_1.types;
...
public class EmployeeCommissionPaymentPreference implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.employees_2017_1.lists.webservices.netsuite.com", "EmployeeCommissionPaymentPreference"));
    }
    /**
