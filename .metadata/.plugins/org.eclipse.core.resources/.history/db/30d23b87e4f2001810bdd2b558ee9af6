...
public class WinLossReasonSearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "WinLossReasonSearchRowBasic"));
