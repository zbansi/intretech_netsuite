...
public class GetCurrencyRateResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.CurrencyRate[] currencyRateList;
    ...
    public GetCurrencyRateResult(
           ...
           com.netsuite.webservices.platform.core_2018_2.CurrencyRate[] currencyRateList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2018_2.CurrencyRate[] getCurrencyRateList() {
        return currencyRateList;
    }
     ...
     */
    public void setCurrencyRateList(com.netsuite.webservices.platform.core_2018_2.CurrencyRate[] currencyRateList) {
        this.currencyRateList = currencyRateList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "GetCurrencyRateResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "currencyRateList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "CurrencyRate"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "currencyRate"));
        typeDesc.addFieldDesc(elemField);
    }
