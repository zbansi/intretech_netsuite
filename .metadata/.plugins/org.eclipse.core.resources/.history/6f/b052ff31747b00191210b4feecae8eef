...
public class GetSelectValueFilter  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.types.GetSelectValueFilterOperator operator;  // attribute
    ...
    public GetSelectValueFilter(
           ...
           com.netsuite.webservices.platform.core_2018_2.types.GetSelectValueFilterOperator operator) {
     ...
     * @return operator
     */
    public com.netsuite.webservices.platform.core_2018_2.types.GetSelectValueFilterOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(com.netsuite.webservices.platform.core_2018_2.types.GetSelectValueFilterOperator operator) {
        this.operator = operator;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "GetSelectValueFilter"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("operator");
        attrField.setXmlName(new javax.xml.namespace.QName("", "operator"));
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2018_2.platform.webservices.netsuite.com", "GetSelectValueFilterOperator"));
        typeDesc.addFieldDesc(attrField);
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filterValue");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "filterValue"));
