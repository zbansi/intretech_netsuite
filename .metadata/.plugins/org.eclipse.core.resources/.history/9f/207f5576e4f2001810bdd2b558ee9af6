...
package com.netsuite.webservices.platform.faults_2017_1.types;
...
public class StatusDetailType implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.faults_2017_1.platform.webservices.netsuite.com", "StatusDetailType"));
    }
    /**
