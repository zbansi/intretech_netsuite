...
public class VendorBillExpense  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2017_1.transactions.webservices.netsuite.com", "VendorBillExpense"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:purchases_2017_1.transactions.webservices.netsuite.com", "category"));
