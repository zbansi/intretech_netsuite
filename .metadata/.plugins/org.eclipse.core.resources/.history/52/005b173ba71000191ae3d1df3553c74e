...
public class SearchLongCustomField  extends com.netsuite.webservices.platform.core_2017_1.SearchCustomField  implements java.io.Serializable {
    private java.lang.Long searchValue;

    private java.lang.Long searchValue2;

    private com.netsuite.webservices.platform.core_2017_1.types.SearchLongFieldOperator operator;  // attribute
    ...
    public SearchLongCustomField(
           ...
           com.netsuite.webservices.platform.core_2017_1.types.SearchLongFieldOperator operator,
     ...
     * @return operator
     */
    public com.netsuite.webservices.platform.core_2017_1.types.SearchLongFieldOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(com.netsuite.webservices.platform.core_2017_1.types.SearchLongFieldOperator operator) {
        this.operator = operator;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchLongCustomField"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("operator");
        attrField.setXmlName(new javax.xml.namespace.QName("", "operator"));
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2017_1.platform.webservices.netsuite.com", "SearchLongFieldOperator"));
