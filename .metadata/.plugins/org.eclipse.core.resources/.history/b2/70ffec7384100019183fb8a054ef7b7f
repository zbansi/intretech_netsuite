...
public final class Messages {
	...
	public static final String TRUE_SHORT_VALUE="";
	public static final String TRUE_LONG_VALUE ="";
	public static final String YES_SHORT_VALUE="";
	public static final String YES_LONG_VALUE="";
	public static final String INVALID_WS_URL="";
	public static final String ERROR_OCCURRED="";
	public static final String WRONG_PROPERTIES_FILE="";
	public static final String PROMPT_FOR_LOGIN_INFORMATION="";
	private Messages() {
	};
}
