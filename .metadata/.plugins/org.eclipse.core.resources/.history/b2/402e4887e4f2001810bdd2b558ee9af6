...
public class PresentationItem  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.common_2017_1.types.PresentationItemType itemType;
    ...
    public PresentationItem(
           ...
           com.netsuite.webservices.platform.common_2017_1.types.PresentationItemType itemType,
     ...
     * @return itemType
     */
    public com.netsuite.webservices.platform.common_2017_1.types.PresentationItemType getItemType() {
        return itemType;
    }
     ...
     * @param itemType
     */
    public void setItemType(com.netsuite.webservices.platform.common_2017_1.types.PresentationItemType itemType) {
        this.itemType = itemType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "PresentationItem"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "itemType"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:types.common_2017_1.platform.webservices.netsuite.com", "PresentationItemType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
