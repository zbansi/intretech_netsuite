...
public class PriceLevelSearchBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRecordBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2018_2.SearchDoubleField discountPct;
    ...
    public PriceLevelSearchBasic(
           com.netsuite.webservices.platform.core_2018_2.SearchDoubleField discountPct,
     ...
     * @return discountPct
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchDoubleField getDiscountPct() {
        return discountPct;
    }
     ...
     * @param discountPct
     */
    public void setDiscountPct(com.netsuite.webservices.platform.core_2018_2.SearchDoubleField discountPct) {
        this.discountPct = discountPct;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "PriceLevelSearchBasic"));
