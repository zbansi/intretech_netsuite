...
public class TaskSearchAdvanced  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.activities.scheduling_2017_1.TaskSearch criteria;

    private com.netsuite.webservices.activities.scheduling_2017_1.TaskSearchRow columns;
    ...
    public TaskSearchAdvanced(
           ...
           com.netsuite.webservices.activities.scheduling_2017_1.TaskSearch criteria,
           com.netsuite.webservices.activities.scheduling_2017_1.TaskSearchRow columns) {
     ...
     * @return criteria
     */
    public com.netsuite.webservices.activities.scheduling_2017_1.TaskSearch getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(com.netsuite.webservices.activities.scheduling_2017_1.TaskSearch criteria) {
        this.criteria = criteria;
    }
     ...
     * @return columns
     */
    public com.netsuite.webservices.activities.scheduling_2017_1.TaskSearchRow getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.netsuite.webservices.activities.scheduling_2017_1.TaskSearchRow columns) {
        this.columns = columns;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2017_1.activities.webservices.netsuite.com", "TaskSearchAdvanced"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2017_1.activities.webservices.netsuite.com", "TaskSearch"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:scheduling_2017_1.activities.webservices.netsuite.com", "TaskSearchRow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
