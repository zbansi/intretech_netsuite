...
public class InitializeRecord  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.InitializeRef[] referenceList;
    ...
    public InitializeRecord(
           ...
           com.netsuite.webservices.platform.core_2019_1.InitializeRef[] referenceList) {
           this.type = type;
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.InitializeRef[] getReferenceList() {
        return referenceList;
    }
     ...
     * @param referenceList
     */
    public void setReferenceList(com.netsuite.webservices.platform.core_2019_1.InitializeRef[] referenceList) {
        this.referenceList = referenceList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "initializeRef"));
        typeDesc.addFieldDesc(elemField);
    }
