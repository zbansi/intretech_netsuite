...
public class BudgetSearchBasic  extends com.netsuite.webservices.platform.core_2019_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef[] year2;
    ...
    public BudgetSearchBasic(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef[] year2,
     ...
     * @return year2
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef[] getYear2() {
        return year2;
    }
     ...
     * @param year2
     */
    public void setYear2(com.netsuite.webservices.platform.core_2019_1.RecordRef[] year2) {
        this.year2 = year2;
    }
