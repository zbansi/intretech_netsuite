...
public class SessionResponse  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.WsRole[] wsRoleList;
    ...
    public SessionResponse(
           ...
           com.netsuite.webservices.platform.core_2019_1.WsRole[] wsRoleList) {
           this.status = status;
           this.userId = userId;
     ...
     * @return wsRoleList
     */
    public com.netsuite.webservices.platform.core_2019_1.WsRole[] getWsRoleList() {
        return wsRoleList;
    }
     ...
     * @param wsRoleList
     */
    public void setWsRoleList(com.netsuite.webservices.platform.core_2019_1.WsRole[] wsRoleList) {
        this.wsRoleList = wsRoleList;
    }
