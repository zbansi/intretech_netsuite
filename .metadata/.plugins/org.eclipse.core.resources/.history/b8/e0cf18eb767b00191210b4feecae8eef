...
public class MerchandiseHierarchyNode  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2019_1.MerchandiseHierarchyNodeHierarchyVersions[] hierarchyVersionsList;
    ...
    public MerchandiseHierarchyNode(
           ...
           com.netsuite.webservices.lists.accounting_2019_1.MerchandiseHierarchyNodeHierarchyVersions[] hierarchyVersionsList) {
        super(
            nullFieldList);
     ...
     */
    public com.netsuite.webservices.lists.accounting_2019_1.MerchandiseHierarchyNodeHierarchyVersions[] getHierarchyVersionsList() {
        return hierarchyVersionsList;
    }
     ...
     */
    public void setHierarchyVersionsList(com.netsuite.webservices.lists.accounting_2019_1.MerchandiseHierarchyNodeHierarchyVersions[] hierarchyVersionsList) {
        this.hierarchyVersionsList = hierarchyVersionsList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "merchandiseHierarchyNodeHierarchyVersions"));
        typeDesc.addFieldDesc(elemField);
    }
