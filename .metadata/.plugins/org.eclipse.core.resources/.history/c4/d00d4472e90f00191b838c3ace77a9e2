...
public class BinSearch  extends com.netsuite.webservices.platform.core_2018_2.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2018_2.BinSearchBasic basic;
    ...
    public BinSearch(
           com.netsuite.webservices.platform.common_2018_2.BinSearchBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2018_2.BinSearchBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2018_2.BinSearchBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2018_2.lists.webservices.netsuite.com", "BinSearch"));
