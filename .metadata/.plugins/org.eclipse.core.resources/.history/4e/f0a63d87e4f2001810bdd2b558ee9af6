...
public class BinSearchBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    public BinSearchBasic(
           com.netsuite.webservices.platform.core_2017_1.SearchStringField binNumber,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "BinSearchBasic"));
