...
public class CustomRecordTypePermissionsPermittedLevel implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.customization_2017_1.setup.webservices.netsuite.com", "CustomRecordTypePermissionsPermittedLevel"));
    }
    /**
