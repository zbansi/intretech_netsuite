...
public class CustomerCategorySearchAdvanced  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearch criteria;

    private com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearchRow columns;
    ...
    public CustomerCategorySearchAdvanced(
           ...
           com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearch criteria,
           com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearchRow columns) {
     ...
     * @return criteria
     */
    public com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearch getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearch criteria) {
        this.criteria = criteria;
    }
     ...
     * @return columns
     */
    public com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearchRow getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.netsuite.webservices.lists.accounting_2017_1.CustomerCategorySearchRow columns) {
        this.columns = columns;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "CustomerCategorySearchAdvanced"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "CustomerCategorySearch"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "CustomerCategorySearchRow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
