...
public class ContactAccessRoles  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "ContactAccessRoles"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "contact"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "role"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
