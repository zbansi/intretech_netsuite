...
public class ItemRevisionSearchRow  extends com.netsuite.webservices.platform.core_2018_2.SearchRow  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2018_2.ItemRevisionSearchRowBasic basic;
    ...
    public ItemRevisionSearchRow(
           com.netsuite.webservices.platform.common_2018_2.ItemRevisionSearchRowBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2018_2.ItemRevisionSearchRowBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2018_2.ItemRevisionSearchRowBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2018_2.lists.webservices.netsuite.com", "ItemRevisionSearchRow"));
