...
public class CustomRecordTypeForms  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2017_1.setup.webservices.netsuite.com", "CustomRecordTypeForms"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("formEdit");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2017_1.setup.webservices.netsuite.com", "formEdit"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2017_1.setup.webservices.netsuite.com", "formName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customization_2017_1.setup.webservices.netsuite.com", "formPref"));
