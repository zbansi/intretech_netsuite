...
public class SearchColumnTextNumberField  extends com.netsuite.webservices.platform.core_2017_1.SearchColumnField  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchColumnTextNumberField"));
