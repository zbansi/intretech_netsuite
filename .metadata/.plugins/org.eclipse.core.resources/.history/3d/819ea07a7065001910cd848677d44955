...
public class ItemNumberCustomField  extends com.netsuite.webservices.setup.customization_2019_1.CustomFieldType  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.setup.customization_2019_1.ItemNumberCustomFieldFilter[] filterList;
    ...
    public ItemNumberCustomField(
           ...
           com.netsuite.webservices.setup.customization_2019_1.ItemNumberCustomFieldFilter[] filterList,
     ...
     * @return filterList
     */
    public com.netsuite.webservices.setup.customization_2019_1.ItemNumberCustomFieldFilter[] getFilterList() {
        return filterList;
    }
     ...
     * @param filterList
     */
    public void setFilterList(com.netsuite.webservices.setup.customization_2019_1.ItemNumberCustomFieldFilter[] filterList) {
        this.filterList = filterList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2019_1.setup.webservices.netsuite.com", "ItemNumberCustomFieldFilter"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
