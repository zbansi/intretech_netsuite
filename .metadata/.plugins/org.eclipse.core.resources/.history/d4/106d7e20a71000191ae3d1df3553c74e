...
public class CustomerPaymentCredit  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customers_2017_1.transactions.webservices.netsuite.com", "CustomerPaymentCredit"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customers_2017_1.transactions.webservices.netsuite.com", "creditDate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:customers_2017_1.transactions.webservices.netsuite.com", "appliedTo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
