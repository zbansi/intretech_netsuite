...
public class WorkOrderCompletionComponent  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "WorkOrderCompletionComponent"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "quantityPer"));
