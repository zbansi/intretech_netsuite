...
public class BinSearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    ...
    public BinSearchRowBasic(
           com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] binNumber,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "BinSearchRowBasic"));
