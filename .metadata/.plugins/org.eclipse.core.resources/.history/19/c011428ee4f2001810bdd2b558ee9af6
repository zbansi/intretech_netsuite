...
public class JobPercentCompleteOverride  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "JobPercentCompleteOverride"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("period");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "period"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "percent"));
