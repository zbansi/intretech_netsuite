...
public class CustomerMessageSearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] preferred;
    ...
    public CustomerMessageSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] preferred) {
     ...
     * @return preferred
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] getPreferred() {
        return preferred;
    }
     ...
     * @param preferred
     */
    public void setPreferred(com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField[] preferred) {
        this.preferred = preferred;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField getPreferred(int i) {
        return this.preferred[i];
    }

    public void setPreferred(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnStringField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "CustomerMessageSearchRowBasic"));
