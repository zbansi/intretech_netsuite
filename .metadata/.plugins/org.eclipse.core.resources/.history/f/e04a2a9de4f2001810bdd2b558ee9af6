...
public class CustomerCategorySearch  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2017_1.CustomerCategorySearchBasic basic;
    ...
    public CustomerCategorySearch(
           com.netsuite.webservices.platform.common_2017_1.CustomerCategorySearchBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2017_1.CustomerCategorySearchBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2017_1.CustomerCategorySearchBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "CustomerCategorySearch"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "CustomerCategorySearchBasic"));
