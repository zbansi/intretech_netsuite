...
public class ContactCategorySearchBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchBooleanField sync;
    ...
    public ContactCategorySearchBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchBooleanField sync) {
     ...
     * @return sync
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchBooleanField getSync() {
        return sync;
    }
     ...
     * @param sync
     */
    public void setSync(com.netsuite.webservices.platform.core_2017_1.SearchBooleanField sync) {
        this.sync = sync;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "ContactCategorySearchBasic"));
