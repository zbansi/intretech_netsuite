...
package com.netsuite.webservices.lists.supplychain_2017_1.types;
...
public class ManufacturingOperationTaskPredecessorPredecessorType implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.supplychain_2017_1.lists.webservices.netsuite.com", "ManufacturingOperationTaskPredecessorPredecessorType"));
    }
    /**
