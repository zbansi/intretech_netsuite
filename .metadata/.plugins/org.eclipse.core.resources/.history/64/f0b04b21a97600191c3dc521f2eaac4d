...
public class MseSubsidiarySearchRowBasic  extends com.netsuite.webservices.platform.core_2019_1.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.SearchColumnBooleanField[] primary;
    ...
    public MseSubsidiarySearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2019_1.SearchColumnBooleanField[] primary,
     ...
     * @return primary
     */
    public com.netsuite.webservices.platform.core_2019_1.SearchColumnBooleanField[] getPrimary() {
        return primary;
    }
     ...
     * @param primary
     */
    public void setPrimary(com.netsuite.webservices.platform.core_2019_1.SearchColumnBooleanField[] primary) {
        this.primary = primary;
    }

    public com.netsuite.webservices.platform.core_2019_1.SearchColumnBooleanField getPrimary(int i) {
        return this.primary[i];
    }

    public void setPrimary(int i, com.netsuite.webservices.platform.core_2019_1.SearchColumnBooleanField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2019_1.platform.webservices.netsuite.com", "MseSubsidiarySearchRowBasic"));
