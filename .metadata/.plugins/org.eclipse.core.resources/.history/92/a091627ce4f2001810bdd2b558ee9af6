...
public class GetCustomizationIdResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.CustomizationRef[] customizationRefList;
    ...
    public GetCustomizationIdResult(
           ...
           com.netsuite.webservices.platform.core_2017_1.CustomizationRef[] customizationRefList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2017_1.CustomizationRef[] getCustomizationRefList() {
        return customizationRefList;
    }
     ...
     */
    public void setCustomizationRefList(com.netsuite.webservices.platform.core_2017_1.CustomizationRef[] customizationRefList) {
        this.customizationRefList = customizationRefList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "GetCustomizationIdResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "customizationRefList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "CustomizationRefList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
