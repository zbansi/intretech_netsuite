...
public class OtherCustomField  extends com.netsuite.webservices.setup.customization_2018_2.CustomFieldType  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.setup.customization_2018_2.OtherCustomFieldFilter[] filterList;
    ...
    public OtherCustomField(
           ...
           com.netsuite.webservices.setup.customization_2018_2.OtherCustomFieldFilter[] filterList,
     ...
     * @return filterList
     */
    public com.netsuite.webservices.setup.customization_2018_2.OtherCustomFieldFilter[] getFilterList() {
        return filterList;
    }
     ...
     * @param filterList
     */
    public void setFilterList(com.netsuite.webservices.setup.customization_2018_2.OtherCustomFieldFilter[] filterList) {
        this.filterList = filterList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:customization_2018_2.setup.webservices.netsuite.com", "OtherCustomField"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customization_2018_2.setup.webservices.netsuite.com", "OtherCustomFieldFilter"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
