...
public class LandedCost  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2019_1.LandedCostData[] landedCostDataList;
    ...
    public LandedCost(
           ...
           com.netsuite.webservices.platform.common_2019_1.LandedCostData[] landedCostDataList) {
        super(
            nullFieldList);
     ...
     */
    public com.netsuite.webservices.platform.common_2019_1.LandedCostData[] getLandedCostDataList() {
        return landedCostDataList;
    }
     ...
     */
    public void setLandedCostDataList(com.netsuite.webservices.platform.common_2019_1.LandedCostData[] landedCostDataList) {
        this.landedCostDataList = landedCostDataList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:common_2019_1.platform.webservices.netsuite.com", "LandedCostData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:common_2019_1.platform.webservices.netsuite.com", "landedCostData"));
