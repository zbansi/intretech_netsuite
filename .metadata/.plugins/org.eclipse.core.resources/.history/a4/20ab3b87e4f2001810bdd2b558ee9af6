...
public class TaxDetailSearchBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRecordBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2017_1.RecordRef[] account;

    private com.netsuite.webservices.platform.core_2017_1.SearchLongField lineNumber;

    private com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxAmount;

    private com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxBasis;

    private com.netsuite.webservices.platform.core_2017_1.RecordRef[] taxCode;

    private com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxRate;

    private com.netsuite.webservices.platform.core_2017_1.RecordRef[] taxType;

    private com.netsuite.webservices.platform.core_2017_1.RecordRef[] tranNumber;
    ...
    public TaxDetailSearchBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchLongField lineNumber,
           com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxAmount,
           com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxBasis,
           com.netsuite.webservices.platform.core_2017_1.RecordRef[] taxCode,
           com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxRate,
           com.netsuite.webservices.platform.core_2017_1.RecordRef[] taxType,
           com.netsuite.webservices.platform.core_2017_1.RecordRef[] tranNumber) {
     ...
     * @return lineNumber
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchLongField getLineNumber() {
        return lineNumber;
    }
     ...
     * @param lineNumber
     */
    public void setLineNumber(com.netsuite.webservices.platform.core_2017_1.SearchLongField lineNumber) {
        this.lineNumber = lineNumber;
    }
     ...
     * @return taxAmount
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchDoubleField getTaxAmount() {
        return taxAmount;
    }
     ...
     * @param taxAmount
     */
    public void setTaxAmount(com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxAmount) {
        this.taxAmount = taxAmount;
    }
     ...
     * @return taxBasis
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchDoubleField getTaxBasis() {
        return taxBasis;
    }
     ...
     * @param taxBasis
     */
    public void setTaxBasis(com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxBasis) {
        this.taxBasis = taxBasis;
    }
     ...
     * @return taxRate
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchDoubleField getTaxRate() {
        return taxRate;
    }
     ...
     * @param taxRate
     */
    public void setTaxRate(com.netsuite.webservices.platform.core_2017_1.SearchDoubleField taxRate) {
        this.taxRate = taxRate;
    }
    ...
    /**
     * Gets the tranNumber value for this TaxDetailSearchBasic.
     * 
     * @return tranNumber
     */
    public com.netsuite.webservices.platform.core_2017_1.RecordRef[] getTranNumber() {
        return tranNumber;
    }


    /**
     * Sets the tranNumber value for this TaxDetailSearchBasic.
     * 
     * @param tranNumber
     */
    public void setTranNumber(com.netsuite.webservices.platform.core_2017_1.RecordRef[] tranNumber) {
        this.tranNumber = tranNumber;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "TaxDetailSearchBasic"));
