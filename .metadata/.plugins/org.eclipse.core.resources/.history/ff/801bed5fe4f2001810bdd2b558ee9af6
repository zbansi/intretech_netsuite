...
public class TransactionSearchAdvanced  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.sales_2017_1.TransactionSearch criteria;

    private com.netsuite.webservices.transactions.sales_2017_1.TransactionSearchRow columns;
    ...
    public TransactionSearchAdvanced(
           ...
           com.netsuite.webservices.transactions.sales_2017_1.TransactionSearch criteria,
           com.netsuite.webservices.transactions.sales_2017_1.TransactionSearchRow columns) {
     ...
     * @return criteria
     */
    public com.netsuite.webservices.transactions.sales_2017_1.TransactionSearch getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(com.netsuite.webservices.transactions.sales_2017_1.TransactionSearch criteria) {
        this.criteria = criteria;
    }
     ...
     * @return columns
     */
    public com.netsuite.webservices.transactions.sales_2017_1.TransactionSearchRow getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.netsuite.webservices.transactions.sales_2017_1.TransactionSearchRow columns) {
        this.columns = columns;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sales_2017_1.transactions.webservices.netsuite.com", "TransactionSearchAdvanced"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2017_1.transactions.webservices.netsuite.com", "TransactionSearch"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sales_2017_1.transactions.webservices.netsuite.com", "TransactionSearchRow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
