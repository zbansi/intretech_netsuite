...
public class GetDataCenterUrlsResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.DataCenterUrls dataCenterUrls;
    ...
    public GetDataCenterUrlsResult(
           ...
           com.netsuite.webservices.platform.core_2017_1.DataCenterUrls dataCenterUrls) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2017_1.DataCenterUrls getDataCenterUrls() {
        return dataCenterUrls;
    }
     ...
     */
    public void setDataCenterUrls(com.netsuite.webservices.platform.core_2017_1.DataCenterUrls dataCenterUrls) {
        this.dataCenterUrls = dataCenterUrls;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "GetDataCenterUrlsResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "dataCenterUrls"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "DataCenterUrls"));
