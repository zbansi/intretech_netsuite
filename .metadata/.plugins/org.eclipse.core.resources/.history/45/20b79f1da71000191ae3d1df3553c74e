...
public class ItemDemandPlanSearchAdvanced  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearch criteria;

    private com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearchRow columns;
    ...
    public ItemDemandPlanSearchAdvanced(
           ...
           com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearch criteria,
           com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearchRow columns) {
     ...
     * @return criteria
     */
    public com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearch getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearch criteria) {
        this.criteria = criteria;
    }
     ...
     * @return columns
     */
    public com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearchRow getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.netsuite.webservices.transactions.demandplanning_2017_1.ItemDemandPlanSearchRow columns) {
        this.columns = columns;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:demandplanning_2017_1.transactions.webservices.netsuite.com", "ItemDemandPlanSearchAdvanced"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:demandplanning_2017_1.transactions.webservices.netsuite.com", "ItemDemandPlanSearch"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:demandplanning_2017_1.transactions.webservices.netsuite.com", "ItemDemandPlanSearchRow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
