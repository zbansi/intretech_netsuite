...
public class PartnerPromoCode  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "PartnerPromoCode"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("promoCode");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "promoCode"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "discount"));
