...
public class SearchColumnDateCustomField  extends com.netsuite.webservices.platform.core_2017_1.SearchColumnCustomField  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchColumnDateCustomField"));
