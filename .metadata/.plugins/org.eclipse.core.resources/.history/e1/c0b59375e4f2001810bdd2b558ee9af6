...
public class DocumentInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2017_1.platform.webservices.netsuite.com", "DocumentInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("nsId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:messages_2017_1.platform.webservices.netsuite.com", "nsId"));
