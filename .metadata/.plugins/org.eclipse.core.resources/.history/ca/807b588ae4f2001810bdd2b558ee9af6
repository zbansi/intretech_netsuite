...
public class ManufacturingCostDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:supplychain_2017_1.lists.webservices.netsuite.com", "ManufacturingCostDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("costCategory");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:supplychain_2017_1.lists.webservices.netsuite.com", "costCategory"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:supplychain_2017_1.lists.webservices.netsuite.com", "fixedRate"));
