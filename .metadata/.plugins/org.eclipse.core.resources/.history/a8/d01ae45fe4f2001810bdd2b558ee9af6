...
package com.netsuite.webservices.transactions.sales_2017_1.types;
...
public class ItemFulfillmentPackageFedExPriorityAlertTypeFedEx implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.sales_2017_1.transactions.webservices.netsuite.com", "ItemFulfillmentPackageFedExPriorityAlertTypeFedEx"));
    }
    /**
