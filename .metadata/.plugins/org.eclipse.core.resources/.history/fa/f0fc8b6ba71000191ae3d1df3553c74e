...
public class CampaignSearchAdvanced  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.lists.marketing_2017_1.CampaignSearch criteria;

    private com.netsuite.webservices.lists.marketing_2017_1.CampaignSearchRow columns;
    ...
    public CampaignSearchAdvanced(
           ...
           com.netsuite.webservices.lists.marketing_2017_1.CampaignSearch criteria,
           com.netsuite.webservices.lists.marketing_2017_1.CampaignSearchRow columns) {
     ...
     * @return criteria
     */
    public com.netsuite.webservices.lists.marketing_2017_1.CampaignSearch getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(com.netsuite.webservices.lists.marketing_2017_1.CampaignSearch criteria) {
        this.criteria = criteria;
    }
     ...
     * @return columns
     */
    public com.netsuite.webservices.lists.marketing_2017_1.CampaignSearchRow getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.netsuite.webservices.lists.marketing_2017_1.CampaignSearchRow columns) {
        this.columns = columns;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "CampaignSearchAdvanced"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "CampaignSearch"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:marketing_2017_1.lists.webservices.netsuite.com", "CampaignSearchRow"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
