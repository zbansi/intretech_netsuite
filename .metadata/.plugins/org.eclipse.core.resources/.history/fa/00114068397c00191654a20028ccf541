...
public class TaxAcct  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2019_1.types.TaxAcctType taxAcctType;
    ...
    public TaxAcct(
           ...
           com.netsuite.webservices.lists.accounting_2019_1.types.TaxAcctType taxAcctType,
     ...
     * @return taxAcctType
     */
    public com.netsuite.webservices.lists.accounting_2019_1.types.TaxAcctType getTaxAcctType() {
        return taxAcctType;
    }
     ...
     * @param taxAcctType
     */
    public void setTaxAcctType(com.netsuite.webservices.lists.accounting_2019_1.types.TaxAcctType taxAcctType) {
        this.taxAcctType = taxAcctType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "TaxAcct"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "taxAcctType"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:types.accounting_2019_1.lists.webservices.netsuite.com", "TaxAcctType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
