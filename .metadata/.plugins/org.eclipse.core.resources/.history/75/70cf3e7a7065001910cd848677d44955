...
public class BomRevision  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2019_1.BomRevisionComponent[] componentList;
    ...
    public BomRevision(
           ...
           com.netsuite.webservices.lists.accounting_2019_1.BomRevisionComponent[] componentList,
     ...
     */
    public com.netsuite.webservices.lists.accounting_2019_1.BomRevisionComponent[] getComponentList() {
        return componentList;
    }
     ...
     * @param componentList
     */
    public void setComponentList(com.netsuite.webservices.lists.accounting_2019_1.BomRevisionComponent[] componentList) {
        this.componentList = componentList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "bomRevisionComponent"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
