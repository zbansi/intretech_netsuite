...
public class ManufacturingCostTemplate  extends com.netsuite.webservices.platform.core_2018_2.Record  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:supplychain_2018_2.lists.webservices.netsuite.com", "ManufacturingCostTemplate"));
