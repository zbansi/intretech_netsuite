...
package com.netsuite.webservices.transactions.demandplanning_2017_1.types;
...
public class ItemDemandPlanProjectionMethod implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.demandplanning_2017_1.transactions.webservices.netsuite.com", "ItemDemandPlanProjectionMethod"));
    }
    /**
