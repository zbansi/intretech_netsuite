...
public class PromotionCodeSearchBasic  extends com.netsuite.webservices.platform.core_2019_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef[] freeShipItem;
    ...
    public PromotionCodeSearchBasic(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef[] freeShipItem,
     ...
     * @return freeShipItem
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef[] getFreeShipItem() {
        return freeShipItem;
    }
     ...
     * @param freeShipItem
     */
    public void setFreeShipItem(com.netsuite.webservices.platform.core_2019_1.RecordRef[] freeShipItem) {
        this.freeShipItem = freeShipItem;
    }
