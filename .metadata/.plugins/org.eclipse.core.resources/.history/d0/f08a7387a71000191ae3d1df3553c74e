...
public class Translation  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2017_1.types.Language locale;
    ...
    public Translation(
           com.netsuite.webservices.platform.common_2017_1.types.Language locale,
     ...
     * @return locale
     */
    public com.netsuite.webservices.platform.common_2017_1.types.Language getLocale() {
        return locale;
    }
     ...
     * @param locale
     */
    public void setLocale(com.netsuite.webservices.platform.common_2017_1.types.Language locale) {
        this.locale = locale;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "Translation"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "language"));
