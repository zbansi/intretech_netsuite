...
public class HcmJobSearchBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchStringField jobId;
    ...
    public HcmJobSearchBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchStringField jobId,
     ...
     * @return jobId
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchStringField getJobId() {
        return jobId;
    }
     ...
     * @param jobId
     */
    public void setJobId(com.netsuite.webservices.platform.core_2018_2.SearchStringField jobId) {
        this.jobId = jobId;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "HcmJobSearchBasic"));
