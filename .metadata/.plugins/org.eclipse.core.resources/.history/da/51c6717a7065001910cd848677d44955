...
public class CalendarEventSearchBasic  extends com.netsuite.webservices.platform.core_2019_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef[] calendar;
    ...
    public CalendarEventSearchBasic(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef[] calendar,
     ...
     * @return calendar
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef[] getCalendar() {
        return calendar;
    }
     ...
     * @param calendar
     */
    public void setCalendar(com.netsuite.webservices.platform.core_2019_1.RecordRef[] calendar) {
        this.calendar = calendar;
    }
