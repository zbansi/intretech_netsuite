...
public class EmployeeSubscriptions  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2017_1.lists.webservices.netsuite.com", "EmployeeSubscriptions"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("subscribed");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2017_1.lists.webservices.netsuite.com", "subscribed"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2017_1.lists.webservices.netsuite.com", "subscription"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
