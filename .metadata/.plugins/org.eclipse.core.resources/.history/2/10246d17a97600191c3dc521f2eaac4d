...
public class CustomRecordTypeSublists  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.setup.customization_2019_1.LanguageValue[] recordDescrLanguageValueList;
    ...
    public CustomRecordTypeSublists(
           ...
           com.netsuite.webservices.setup.customization_2019_1.LanguageValue[] recordDescrLanguageValueList,
     ...
     */
    public com.netsuite.webservices.setup.customization_2019_1.LanguageValue[] getRecordDescrLanguageValueList() {
        return recordDescrLanguageValueList;
    }
     ...
     */
    public void setRecordDescrLanguageValueList(com.netsuite.webservices.setup.customization_2019_1.LanguageValue[] recordDescrLanguageValueList) {
        this.recordDescrLanguageValueList = recordDescrLanguageValueList;
    }
