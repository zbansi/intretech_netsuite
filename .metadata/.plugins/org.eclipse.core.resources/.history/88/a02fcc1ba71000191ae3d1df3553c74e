...
public class PaycheckJournalEarning  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2017_1.transactions.webservices.netsuite.com", "PaycheckJournalEarning"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("id");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2017_1.transactions.webservices.netsuite.com", "id"));
