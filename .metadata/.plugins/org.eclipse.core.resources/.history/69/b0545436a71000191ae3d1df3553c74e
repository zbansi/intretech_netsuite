...
public class SearchEnumMultiSelectCustomField  extends com.netsuite.webservices.platform.core_2017_1.SearchCustomField  implements java.io.Serializable {
    private java.lang.String[] searchValue;

    private com.netsuite.webservices.platform.core_2017_1.types.SearchEnumMultiSelectFieldOperator operator;  // attribute
    ...
    public SearchEnumMultiSelectCustomField(
           ...
           com.netsuite.webservices.platform.core_2017_1.types.SearchEnumMultiSelectFieldOperator operator,
     ...
     * @return operator
     */
    public com.netsuite.webservices.platform.core_2017_1.types.SearchEnumMultiSelectFieldOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(com.netsuite.webservices.platform.core_2017_1.types.SearchEnumMultiSelectFieldOperator operator) {
        this.operator = operator;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchEnumMultiSelectCustomField"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("operator");
        attrField.setXmlName(new javax.xml.namespace.QName("", "operator"));
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2017_1.platform.webservices.netsuite.com", "SearchEnumMultiSelectFieldOperator"));
