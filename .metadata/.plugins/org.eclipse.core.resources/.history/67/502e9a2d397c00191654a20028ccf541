...
public class DepositApplication  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.transactions.customers_2019_1.DepositApplicationApply[] applyList;
    ...
    public DepositApplication(
           ...
           com.netsuite.webservices.transactions.customers_2019_1.DepositApplicationApply[] applyList,
     ...
     * @return applyList
     */
    public com.netsuite.webservices.transactions.customers_2019_1.DepositApplicationApply[] getApplyList() {
        return applyList;
    }
     ...
     * @param applyList
     */
    public void setApplyList(com.netsuite.webservices.transactions.customers_2019_1.DepositApplicationApply[] applyList) {
        this.applyList = applyList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:customers_2019_1.transactions.webservices.netsuite.com", "DepositApplicationApply"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
