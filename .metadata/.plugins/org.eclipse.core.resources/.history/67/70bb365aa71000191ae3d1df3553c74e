...
package com.netsuite.webservices.lists.support_2017_1.types;
...
public class SupportCaseStatusStage implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.support_2017_1.lists.webservices.netsuite.com", "SupportCaseStatusStage"));
    }
    /**
