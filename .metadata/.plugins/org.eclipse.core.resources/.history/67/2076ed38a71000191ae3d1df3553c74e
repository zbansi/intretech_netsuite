...
public class DeletedRecord  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.BaseRef record;
    ...
    public DeletedRecord(
           ...
           com.netsuite.webservices.platform.core_2017_1.BaseRef record) {
     ...
     * @return record
     */
    public com.netsuite.webservices.platform.core_2017_1.BaseRef getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(com.netsuite.webservices.platform.core_2017_1.BaseRef record) {
        this.record = record;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "DeletedRecord"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "record"));
