...
public class RevRecSchedule  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.accounting_2019_1.RevRecScheduleRecurrence[] recurrenceList;
    ...
    public RevRecSchedule(
           ...
           com.netsuite.webservices.lists.accounting_2019_1.RevRecScheduleRecurrence[] recurrenceList) {
        super(
            nullFieldList);
     ...
     */
    public com.netsuite.webservices.lists.accounting_2019_1.RevRecScheduleRecurrence[] getRecurrenceList() {
        return recurrenceList;
    }
     ...
     */
    public void setRecurrenceList(com.netsuite.webservices.lists.accounting_2019_1.RevRecScheduleRecurrence[] recurrenceList) {
        this.recurrenceList = recurrenceList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:accounting_2019_1.lists.webservices.netsuite.com", "revRecScheduleRecurrence"));
        typeDesc.addFieldDesc(elemField);
    }
