...
public class TaxTypeSearch  extends com.netsuite.webservices.platform.core_2018_2.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2018_2.TaxTypeSearchBasic basic;
    ...
    public TaxTypeSearch(
           com.netsuite.webservices.platform.common_2018_2.TaxTypeSearchBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2018_2.TaxTypeSearchBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2018_2.TaxTypeSearchBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2018_2.lists.webservices.netsuite.com", "TaxTypeSearch"));
