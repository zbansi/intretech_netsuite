...
public class CheckExpense  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:bank_2018_2.transactions.webservices.netsuite.com", "CheckExpense"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:bank_2018_2.transactions.webservices.netsuite.com", "category"));
