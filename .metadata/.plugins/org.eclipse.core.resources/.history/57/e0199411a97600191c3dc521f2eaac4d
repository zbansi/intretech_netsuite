...
public class PeriodEndJournal  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.transactions.general_2019_1.PeriodEndJournalLine[] lineList;
    ...
    public PeriodEndJournal(
           ...
           com.netsuite.webservices.transactions.general_2019_1.PeriodEndJournalLine[] lineList,
     ...
     * @return lineList
     */
    public com.netsuite.webservices.transactions.general_2019_1.PeriodEndJournalLine[] getLineList() {
        return lineList;
    }
     ...
     * @param lineList
     */
    public void setLineList(com.netsuite.webservices.transactions.general_2019_1.PeriodEndJournalLine[] lineList) {
        this.lineList = lineList;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:general_2019_1.transactions.webservices.netsuite.com", "periodEndJournalLine"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
