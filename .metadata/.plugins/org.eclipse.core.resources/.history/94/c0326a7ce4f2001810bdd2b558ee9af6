...
public class SearchStringCustomField  extends com.netsuite.webservices.platform.core_2017_1.SearchCustomField  implements java.io.Serializable {
    private java.lang.String searchValue;

    private com.netsuite.webservices.platform.core_2017_1.types.SearchStringFieldOperator operator;  // attribute
    ...
    public SearchStringCustomField(
           ...
           com.netsuite.webservices.platform.core_2017_1.types.SearchStringFieldOperator operator,
     ...
     * @return operator
     */
    public com.netsuite.webservices.platform.core_2017_1.types.SearchStringFieldOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(com.netsuite.webservices.platform.core_2017_1.types.SearchStringFieldOperator operator) {
        this.operator = operator;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchStringCustomField"));
        org.apache.axis.description.AttributeDesc attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("operator");
        attrField.setXmlName(new javax.xml.namespace.QName("", "operator"));
        attrField.setXmlType(new javax.xml.namespace.QName("urn:types.core_2017_1.platform.webservices.netsuite.com", "SearchStringFieldOperator"));
