...
public class ItemDemandPlan  extends com.netsuite.webservices.platform.core_2019_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.transactions.demandplanning_2019_1.DemandPlan[] demandPlanMatrix;
    ...
    public ItemDemandPlan(
           ...
           com.netsuite.webservices.transactions.demandplanning_2019_1.DemandPlan[] demandPlanMatrix,
     ...
     */
    public com.netsuite.webservices.transactions.demandplanning_2019_1.DemandPlan[] getDemandPlanMatrix() {
        return demandPlanMatrix;
    }
     ...
     */
    public void setDemandPlanMatrix(com.netsuite.webservices.transactions.demandplanning_2019_1.DemandPlan[] demandPlanMatrix) {
        this.demandPlanMatrix = demandPlanMatrix;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:demandplanning_2019_1.transactions.webservices.netsuite.com", "demandPlan"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
