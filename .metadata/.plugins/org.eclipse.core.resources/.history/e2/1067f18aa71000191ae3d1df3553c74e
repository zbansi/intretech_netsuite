...
public class PartnerCategorySearchRow  extends com.netsuite.webservices.platform.core_2017_1.SearchRow  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2017_1.PartnerCategorySearchRowBasic basic;
    ...
    public PartnerCategorySearchRow(
           com.netsuite.webservices.platform.common_2017_1.PartnerCategorySearchRowBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2017_1.PartnerCategorySearchRowBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2017_1.PartnerCategorySearchRowBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "PartnerCategorySearchRow"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "PartnerCategorySearchRowBasic"));
