...
public class GetDeletedResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.DeletedRecord[] deletedRecordList;
    ...
    public GetDeletedResult(
           ...
           com.netsuite.webservices.platform.core_2018_2.DeletedRecord[] deletedRecordList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2018_2.DeletedRecord[] getDeletedRecordList() {
        return deletedRecordList;
    }
     ...
     */
    public void setDeletedRecordList(com.netsuite.webservices.platform.core_2018_2.DeletedRecord[] deletedRecordList) {
        this.deletedRecordList = deletedRecordList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "GetDeletedResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "deletedRecordList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "DeletedRecordList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
