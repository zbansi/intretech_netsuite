...
public class GetDeletedResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.DeletedRecord[] deletedRecordList;
    ...
    public GetDeletedResult(
           ...
           com.netsuite.webservices.platform.core_2019_1.DeletedRecord[] deletedRecordList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.DeletedRecord[] getDeletedRecordList() {
        return deletedRecordList;
    }
     ...
     */
    public void setDeletedRecordList(com.netsuite.webservices.platform.core_2019_1.DeletedRecord[] deletedRecordList) {
        this.deletedRecordList = deletedRecordList;
    }
