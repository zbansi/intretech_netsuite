...
public class InboundShipmentLandedCost  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.RecordRef[] landedCostShipmentItemsList;
    ...
    public InboundShipmentLandedCost(
           ...
           com.netsuite.webservices.platform.core_2019_1.RecordRef[] landedCostShipmentItemsList) {
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.RecordRef[] getLandedCostShipmentItemsList() {
        return landedCostShipmentItemsList;
    }
     ...
     */
    public void setLandedCostShipmentItemsList(com.netsuite.webservices.platform.core_2019_1.RecordRef[] landedCostShipmentItemsList) {
        this.landedCostShipmentItemsList = landedCostShipmentItemsList;
    }
