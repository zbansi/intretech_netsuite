...
public class GetItemAvailabilityResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2019_1.ItemAvailability[] itemAvailabilityList;
    ...
    public GetItemAvailabilityResult(
           ...
           com.netsuite.webservices.platform.core_2019_1.ItemAvailability[] itemAvailabilityList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2019_1.ItemAvailability[] getItemAvailabilityList() {
        return itemAvailabilityList;
    }
     ...
     */
    public void setItemAvailabilityList(com.netsuite.webservices.platform.core_2019_1.ItemAvailability[] itemAvailabilityList) {
        this.itemAvailabilityList = itemAvailabilityList;
    }
    ...
    static {
        ...
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:core_2019_1.platform.webservices.netsuite.com", "itemAvailability"));
        typeDesc.addFieldDesc(elemField);
    }
