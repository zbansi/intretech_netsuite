...
public class InboundShipmentLandedCostAllocationMethod implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.purchases_2018_2.transactions.webservices.netsuite.com", "InboundShipmentLandedCostAllocationMethod"));
    }
    /**
