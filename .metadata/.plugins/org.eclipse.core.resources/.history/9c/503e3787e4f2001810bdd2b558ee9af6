...
public class ExpenseCategorySearchBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchBooleanField rateRequired;
    ...
    public ExpenseCategorySearchBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchBooleanField rateRequired,
     ...
     * @return rateRequired
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchBooleanField getRateRequired() {
        return rateRequired;
    }
     ...
     * @param rateRequired
     */
    public void setRateRequired(com.netsuite.webservices.platform.core_2017_1.SearchBooleanField rateRequired) {
        this.rateRequired = rateRequired;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "ExpenseCategorySearchBasic"));
