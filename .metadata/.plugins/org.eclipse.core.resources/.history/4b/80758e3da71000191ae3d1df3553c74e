...
public class NoteSearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] author;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] direction;
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] note;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnDateField[] noteDate;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] noteType;
    ...
    public NoteSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] direction,
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] note,
           com.netsuite.webservices.platform.core_2018_2.SearchColumnDateField[] noteDate,
           com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] noteType,
     ...
     * @return direction
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] getDirection() {
        return direction;
    }
     ...
     * @param direction
     */
    public void setDirection(com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] direction) {
        this.direction = direction;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField getDirection(int i) {
        return this.direction[i];
    }

    public void setDirection(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField _value) {
     ...
     * @return note
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] getNote() {
        return note;
    }
     ...
     * @param note
     */
    public void setNote(com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] note) {
        this.note = note;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField getNote(int i) {
        return this.note[i];
    }

    public void setNote(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField _value) {
        this.note[i] = _value;
    }
     ...
     * @return noteDate
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnDateField[] getNoteDate() {
        return noteDate;
    }
     ...
     * @param noteDate
     */
    public void setNoteDate(com.netsuite.webservices.platform.core_2018_2.SearchColumnDateField[] noteDate) {
        this.noteDate = noteDate;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnDateField getNoteDate(int i) {
        return this.noteDate[i];
    }

    public void setNoteDate(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnDateField _value) {
     ...
     * @return noteType
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] getNoteType() {
        return noteType;
    }
     ...
     * @param noteType
     */
    public void setNoteType(com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField[] noteType) {
        this.noteType = noteType;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField getNoteType(int i) {
        return this.noteType[i];
    }

    public void setNoteType(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnStringField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "NoteSearchRowBasic"));
