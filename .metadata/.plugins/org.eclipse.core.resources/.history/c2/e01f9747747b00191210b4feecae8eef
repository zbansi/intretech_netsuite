...
public class BillingAccountSearchRow  extends com.netsuite.webservices.platform.core_2018_2.SearchRow  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2018_2.BillingAccountSearchRowBasic basic;
    ...
    public BillingAccountSearchRow(
           com.netsuite.webservices.platform.common_2018_2.BillingAccountSearchRowBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2018_2.BillingAccountSearchRowBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2018_2.BillingAccountSearchRowBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2018_2.lists.webservices.netsuite.com", "BillingAccountSearchRow"));
