...
public class PartnerInfo  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:messages_2017_1.platform.webservices.netsuite.com", "PartnerInfo"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("partnerId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:messages_2017_1.platform.webservices.netsuite.com", "partnerId"));
