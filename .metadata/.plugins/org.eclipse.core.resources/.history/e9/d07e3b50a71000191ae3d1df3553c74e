...
public class CurrencyRateSearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] baseCurrency;
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] transactionCurrency;

    public CurrencyRateSearchRowBasic() {
    }

    public CurrencyRateSearchRowBasic(
           com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] baseCurrency,
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] transactionCurrency) {
     ...
     * @return baseCurrency
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] getBaseCurrency() {
        return baseCurrency;
    }
     ...
     * @param baseCurrency
     */
    public void setBaseCurrency(com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] baseCurrency) {
        this.baseCurrency = baseCurrency;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField getBaseCurrency(int i) {
        return this.baseCurrency[i];
    }

    public void setBaseCurrency(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField _value) {
     ...
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] getTransactionCurrency() {
        return transactionCurrency;
    }
     ...
     */
    public void setTransactionCurrency(com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] transactionCurrency) {
        this.transactionCurrency = transactionCurrency;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField getTransactionCurrency(int i) {
        return this.transactionCurrency[i];
    }

    public void setTransactionCurrency(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "CurrencyRateSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "transactionCurrency"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchColumnSelectField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
