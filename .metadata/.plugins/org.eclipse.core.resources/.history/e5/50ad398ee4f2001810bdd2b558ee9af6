...
public class VendorPricingSchedule  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "VendorPricingSchedule"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("scheduleName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "scheduleName"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:relationships_2017_1.lists.webservices.netsuite.com", "scheduleDiscount"));
