...
public class PaymentMethodSearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnSelectField[] account;

    private com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] creditCard;
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] isDebitCard;
    ...
    public PaymentMethodSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] creditCard,
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] isDebitCard,
     ...
     * @return creditCard
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] getCreditCard() {
        return creditCard;
    }
     ...
     * @param creditCard
     */
    public void setCreditCard(com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] creditCard) {
        this.creditCard = creditCard;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField getCreditCard(int i) {
        return this.creditCard[i];
    }

    public void setCreditCard(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField _value) {
     ...
     * @return isDebitCard
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] getIsDebitCard() {
        return isDebitCard;
    }
     ...
     * @param isDebitCard
     */
    public void setIsDebitCard(com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField[] isDebitCard) {
        this.isDebitCard = isDebitCard;
    }

    public com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField getIsDebitCard(int i) {
        return this.isDebitCard[i];
    }

    public void setIsDebitCard(int i, com.netsuite.webservices.platform.core_2017_1.SearchColumnBooleanField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "PaymentMethodSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "creditCard"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "isDebitCard"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "SearchColumnBooleanField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
