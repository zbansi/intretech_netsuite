...
public class InventoryNumberSearchRow  extends com.netsuite.webservices.platform.core_2018_2.SearchRow  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2018_2.InventoryNumberSearchRowBasic basic;
    ...
    public InventoryNumberSearchRow(
           com.netsuite.webservices.platform.common_2018_2.InventoryNumberSearchRowBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2018_2.InventoryNumberSearchRowBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2018_2.InventoryNumberSearchRowBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2018_2.lists.webservices.netsuite.com", "InventoryNumberSearchRow"));
