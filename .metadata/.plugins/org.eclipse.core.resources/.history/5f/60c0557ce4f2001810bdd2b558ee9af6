...
package com.netsuite.webservices.platform.core_2017_1.types;
...
public class SearchEnumMultiSelectFieldOperator implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.core_2017_1.platform.webservices.netsuite.com", "SearchEnumMultiSelectFieldOperator"));
    }
    /**
