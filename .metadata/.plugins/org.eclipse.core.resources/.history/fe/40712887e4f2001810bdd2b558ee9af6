...
public class VendorCategorySearchBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.SearchBooleanField isTaxAgency;
    ...
    public VendorCategorySearchBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchBooleanField isTaxAgency,
     ...
     * @return isTaxAgency
     */
    public com.netsuite.webservices.platform.core_2017_1.SearchBooleanField getIsTaxAgency() {
        return isTaxAgency;
    }
     ...
     * @param isTaxAgency
     */
    public void setIsTaxAgency(com.netsuite.webservices.platform.core_2017_1.SearchBooleanField isTaxAgency) {
        this.isTaxAgency = isTaxAgency;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "VendorCategorySearchBasic"));
