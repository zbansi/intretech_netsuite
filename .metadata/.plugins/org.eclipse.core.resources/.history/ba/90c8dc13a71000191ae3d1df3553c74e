...
public class ItemReceiptExpense  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:purchases_2017_1.transactions.webservices.netsuite.com", "ItemReceiptExpense"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("markReceived");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:purchases_2017_1.transactions.webservices.netsuite.com", "markReceived"));
