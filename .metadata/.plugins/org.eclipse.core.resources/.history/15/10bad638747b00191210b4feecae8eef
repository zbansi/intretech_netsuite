...
public class ContactCategorySearchBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRecordBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchBooleanField sync;
    ...
    public ContactCategorySearchBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchBooleanField sync) {
     ...
     * @return sync
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchBooleanField getSync() {
        return sync;
    }
     ...
     * @param sync
     */
    public void setSync(com.netsuite.webservices.platform.core_2018_2.SearchBooleanField sync) {
        this.sync = sync;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "ContactCategorySearchBasic"));
