...
public class ExceededConcurrentRequestLimitFault  extends com.netsuite.webservices.platform.faults_2018_2.SoapFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:faults_2018_2.platform.webservices.netsuite.com", "ExceededConcurrentRequestLimitFault"));
    }
