...
public class AssemblyUnbuild  extends com.netsuite.webservices.platform.core_2017_1.Record  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "AssemblyUnbuild"));
