...
public class CostCategorySearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] itemCostType;
    ...
    public CostCategorySearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] itemCostType,
     ...
     * @return itemCostType
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] getItemCostType() {
        return itemCostType;
    }
     ...
     * @param itemCostType
     */
    public void setItemCostType(com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField[] itemCostType) {
        this.itemCostType = itemCostType;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField getItemCostType(int i) {
        return this.itemCostType[i];
    }

    public void setItemCostType(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnEnumSelectField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "CostCategorySearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "itemCostType"));
