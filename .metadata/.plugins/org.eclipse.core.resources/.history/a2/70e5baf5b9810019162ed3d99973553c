...
public class CampaignEmail  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.lists.marketing_2019_1.types.CampaignCampaignEmailStatus status;
    ...
    public CampaignEmail(
           ...
           com.netsuite.webservices.lists.marketing_2019_1.types.CampaignCampaignEmailStatus status,
     ...
     * @return status
     */
    public com.netsuite.webservices.lists.marketing_2019_1.types.CampaignCampaignEmailStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.netsuite.webservices.lists.marketing_2019_1.types.CampaignCampaignEmailStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:marketing_2019_1.lists.webservices.netsuite.com", "CampaignEmail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:types.marketing_2019_1.lists.webservices.netsuite.com", "CampaignCampaignEmailStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
