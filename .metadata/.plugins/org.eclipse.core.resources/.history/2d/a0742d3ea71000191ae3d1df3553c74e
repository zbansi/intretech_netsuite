...
public class NexusSearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] parentNexus;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] state;

    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] taxAgency;
    ...
    public NexusSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] parentNexus,
           com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] state,
           com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] taxAgency) {
     ...
     * @return parentNexus
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] getParentNexus() {
        return parentNexus;
    }
     ...
     * @param parentNexus
     */
    public void setParentNexus(com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] parentNexus) {
        this.parentNexus = parentNexus;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField getParentNexus(int i) {
        return this.parentNexus[i];
    }

    public void setParentNexus(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField _value) {
     ...
     * @return taxAgency
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] getTaxAgency() {
        return taxAgency;
    }
     ...
     * @param taxAgency
     */
    public void setTaxAgency(com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] taxAgency) {
        this.taxAgency = taxAgency;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField getTaxAgency(int i) {
        return this.taxAgency[i];
    }

    public void setTaxAgency(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "NexusSearchRowBasic"));
