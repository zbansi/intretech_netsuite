...
public class GetPostingTransactionSummaryResult  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2017_1.PostingTransactionSummary[] postingTransactionSummaryList;
    ...
    public GetPostingTransactionSummaryResult(
           ...
           com.netsuite.webservices.platform.core_2017_1.PostingTransactionSummary[] postingTransactionSummaryList) {
           this.status = status;
     ...
     */
    public com.netsuite.webservices.platform.core_2017_1.PostingTransactionSummary[] getPostingTransactionSummaryList() {
        return postingTransactionSummaryList;
    }
     ...
     */
    public void setPostingTransactionSummaryList(com.netsuite.webservices.platform.core_2017_1.PostingTransactionSummary[] postingTransactionSummaryList) {
        this.postingTransactionSummaryList = postingTransactionSummaryList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "GetPostingTransactionSummaryResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "pageSize"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "totalPages"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "pageIndex"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "postingTransactionSummaryList"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "PostingTransactionSummary"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:core_2017_1.platform.webservices.netsuite.com", "postingTransactionSummary"));
        typeDesc.addFieldDesc(elemField);
    }
