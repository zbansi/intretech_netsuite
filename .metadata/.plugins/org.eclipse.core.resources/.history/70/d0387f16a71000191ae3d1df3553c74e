...
public class TransferOrder  extends com.netsuite.webservices.platform.core_2017_1.Record  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.transactions.inventory_2017_1.TransferOrderItem[] itemList;
    ...
    public TransferOrder(
           ...
           com.netsuite.webservices.transactions.inventory_2017_1.TransferOrderItem[] itemList,
     ...
     * @return itemList
     */
    public com.netsuite.webservices.transactions.inventory_2017_1.TransferOrderItem[] getItemList() {
        return itemList;
    }
     ...
     * @param itemList
     */
    public void setItemList(com.netsuite.webservices.transactions.inventory_2017_1.TransferOrderItem[] itemList) {
        this.itemList = itemList;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "TransferOrder"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "TransferOrderItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
