...
public class UsageSearchRowBasic  extends com.netsuite.webservices.platform.core_2018_2.SearchRowBasic  implements java.io.Serializable {
    ...
    private com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] subscriptionPlan;
    ...
    public UsageSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] subscriptionPlan) {
     ...
     */
    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] getSubscriptionPlan() {
        return subscriptionPlan;
    }
     ...
     */
    public void setSubscriptionPlan(com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField[] subscriptionPlan) {
        this.subscriptionPlan = subscriptionPlan;
    }

    public com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField getSubscriptionPlan(int i) {
        return this.subscriptionPlan[i];
    }

    public void setSubscriptionPlan(int i, com.netsuite.webservices.platform.core_2018_2.SearchColumnSelectField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "UsageSearchRowBasic"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:common_2018_2.platform.webservices.netsuite.com", "subscriptionPlan"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:core_2018_2.platform.webservices.netsuite.com", "SearchColumnSelectField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
