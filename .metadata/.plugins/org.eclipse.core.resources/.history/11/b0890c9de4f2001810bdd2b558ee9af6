...
public class AccountingPeriodSearch  extends com.netsuite.webservices.platform.core_2017_1.SearchRecord  implements java.io.Serializable {
    private com.netsuite.webservices.platform.common_2017_1.AccountingPeriodSearchBasic basic;
    ...
    public AccountingPeriodSearch(
           com.netsuite.webservices.platform.common_2017_1.AccountingPeriodSearchBasic basic,
     ...
     * @return basic
     */
    public com.netsuite.webservices.platform.common_2017_1.AccountingPeriodSearchBasic getBasic() {
        return basic;
    }
     ...
     * @param basic
     */
    public void setBasic(com.netsuite.webservices.platform.common_2017_1.AccountingPeriodSearchBasic basic) {
        this.basic = basic;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:accounting_2017_1.lists.webservices.netsuite.com", "AccountingPeriodSearch"));
