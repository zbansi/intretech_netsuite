...
public class ItemRevisionSearchRowBasic  extends com.netsuite.webservices.platform.core_2017_1.SearchRowBasic  implements java.io.Serializable {
    ...
    public ItemRevisionSearchRowBasic(
           ...
           com.netsuite.webservices.platform.core_2017_1.SearchColumnDateField[] obsoleteDate) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:common_2017_1.platform.webservices.netsuite.com", "ItemRevisionSearchRowBasic"));
