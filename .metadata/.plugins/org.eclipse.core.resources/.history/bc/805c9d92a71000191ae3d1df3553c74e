...
package com.netsuite.webservices.activities.scheduling_2017_1.types;
...
public class ProjectTaskPredecessorPredecessorType implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:types.scheduling_2017_1.activities.webservices.netsuite.com", "ProjectTaskPredecessorPredecessorType"));
    }
    /**
