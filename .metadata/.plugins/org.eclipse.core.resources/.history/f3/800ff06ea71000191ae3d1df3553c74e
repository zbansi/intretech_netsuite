...
public class EmployeeEmergencyContact  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:employees_2017_1.lists.webservices.netsuite.com", "EmployeeEmergencyContact"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2017_1.lists.webservices.netsuite.com", "contact"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2017_1.lists.webservices.netsuite.com", "relationship"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:employees_2017_1.lists.webservices.netsuite.com", "address"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
