...
public class InventoryTransferInventory  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "InventoryTransferInventory"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "fromBinNumbers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:inventory_2017_1.transactions.webservices.netsuite.com", "toBinNumbers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
